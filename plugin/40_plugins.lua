...
later(function()
  ...
  vim.keymap.set('n', '<Leader>tt', '<Cmd>OverseerRun<CR>', { desc = 'Run Overseer task' })
  vim.keymap.set('n', '<Leader>tr', '<Cmd>OverseerRestartLast<CR>', { desc = 'Restart last Overseer task' })
  vim.keymap.set('n', '<Leader>ts', ':OverseerShell ', { desc = 'Run shell command with Overseer' })
  vim.keymap.set('n', '<Leader>to', '<Cmd>OverseerToggle<CR>', { desc = 'Toggle Overseer' })
