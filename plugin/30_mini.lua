...
-- 'mini.pick', Oil, 'mini.statusline', and others.
now(function()
...
-- Statusline is provided by 'lualine.nvim'; see 'plugin/40_plugins.lua'.
...
-- special buffers (like for 'mini.starter' or Oil) to not conflict
